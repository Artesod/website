  ...
  return (
    <section id="hero" className="section-snap flex flex-col items-center justify-center text-center relative px-6">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl">
        <motion.div className="relative mb-10" {...fadeUp(0.1)}>
          <div className="absolute inset-0 scale-150 bg-blue-accent/20 rounded-full blur-3xl pointer-events-none" />
          <img
            src={logo}
            alt="JC"
            className="relative w-36 h-36 md:w-48 md:h-48 lg:w-56 lg:h-56 filter invert"
          />
        </motion.div>

        <motion.p
          className="font-mono text-emerald-accent text-sm md:text-base tracking-widest uppercase mb-5"
          {...fadeUp(0.25)}
        >
        ...
        <motion.h1
          className="text-6xl md:text-8xl lg:text-9xl font-black text-text-primary leading-none mb-5"
          {...fadeUp(0.4)}
        >
          {profile.firstName}{' '}
        ...
        <motion.p
          className="font-mono text-text-secondary text-lg md:text-xl h-8 mb-10"
          {...fadeUp(0.55)}
        >
          {typed}
        ...
        <motion.div className="flex flex-wrap items-center gap-5 mb-12" {...fadeUp(0.7)}>
          <Button
            variant="primary"
        ...
        <motion.div className="flex items-center gap-6" {...fadeUp(0.85)}>
          <a
